...
const About = () => {
    return (
      <div className='about-container'>
          <h2 className='aboutUs-title'>About T.I.M.</h2>
          <article className='aboutUs-container'>
            <h2 className='aboutUs-title'>Dad Jokes on Demand</h2>
            ...
            <p className='about-us'>
              ...
              <Link color="#9966cc" href="https://github.com/thomedpete" underline="none"> Thomas</Link>
              <Link color="#9966cc" href="https://www.linkedin.com/in/thomas-peterson-web-dev/" underline="none"> Peterson</Link>, I -
